...
Multiselect options must implement [`ListDisplayable`](./ListDisplayable.md) to provide a displayable value.
...
Along with [common fields](../Common.md), the default multiselect field includes multiple
